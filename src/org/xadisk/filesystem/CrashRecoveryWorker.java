...
public class CrashRecoveryWorker implements Work {
    ...
    CrashRecoveryWorker(XAFileSystem xaFileSystem) {
        this.xaFileSystem = xaFileSystem;
    }

    void collectLogFileNamesToProcess() throws IOException {
    ...
    private void recoverOnePhaseTransactions() throws Exception {
        ...
        for (XidImpl xid : onePhaseCommittingTransactions) {
            ...
            Session recoverySession = xaFileSystem.createRecoverySession(xid);
    ...
    ArrayList<Long> getTransactionLogsPositions(XidImpl xid) {
    ...
    HashSet getFilesOnDiskForTransaction(XidImpl xid) {
        return transactionsAndFilesWithLatestViewOnDisk.get(xid);
    }

    ArrayList<FileStateChangeEvent> getFileSystemEventsFromCommittedTransactions() {
    ...
    private class TransactionCompleter implements Work {
        ...
        private TransactionCompleter(Session session, CrashRecoveryWorker crashRecoveryWorker, boolean toCommit) {
