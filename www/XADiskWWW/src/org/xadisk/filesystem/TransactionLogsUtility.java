...
class TransactionLogsUtility {

    static void addLogPositionToTransaction(XidImpl xid, int logFileIndex,
    ...
    static void deleteLogsIfPossible(XidImpl xid, Map<XidImpl, ArrayList<Integer>> transactionsAndLogsOccupied,
    ...
    static void trackTransactionLogsUsage(XidImpl xid, Map<XidImpl, ArrayList<Integer>> transactionsAndLogsOccupied,
