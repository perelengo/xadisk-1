...
public class JDIEventsHandler implements Runnable {
    ...
    public JDIEventsHandler(VirtualMachine vm, String transactionDemarcatingThread,
        ...
        String class1 = org.xadisk.filesystem.GatheringDiskWriter.class.getName();
        ...
        String class2 = org.xadisk.filesystem.Session.class.getName();
        ArrayList<String> methods2 = new ArrayList<String>();
        java.lang.reflect.Method allMethods2[] = org.xadisk.filesystem.Session.class.getDeclaredMethods();
